        ...
        <div className='bg-[#161511] w-full text-white'>
            <div className=' w-full max-w-7xl h-[50vh] p-5 pb-8 mx-auto footer'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <Link to='/carrier'><p className='font text-lg'>Carrier</p></Link>
                </div>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-4'>
                        <input type="email" value={text} onChange={(e)=>setText(e.target.value)} class="block py-2.5  pe-0 w-full  text-white font text-lg bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#85833c] focus:outline-none focus:ring-0 focus:border-[#85833c] peer placeholder:text-lg font text-white" placeholder="Enter your e-mail address" />
            ...
            <p className='text-center pb-9 font text-md text-[#696767]'>© 2024 Italia <br />Developed by Hermas</p>
        </div>
    )
}
