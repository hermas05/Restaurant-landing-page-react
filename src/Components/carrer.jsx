...
const Carrier = () => {
  return (
    <>
      ...
      <div className='w-full h-[50vh] about-background flex flex-col items-center justify-center'><h1 className='text-white text-[4rem] middle-text font-bold mt-14'>Carrer</h1>
      </div>
      <div className='w-full h-[90vh] p-[100px] bg-[#dddcdc] '>
      <h3 className='text-[#696767] font font-bold text-lg '>CARRER</h3>
        <div className='bg-[#85833c] h-[3px] w-[12dvh] my-3'></div>
        <div><h1 className='text-black text-[3rem] middle-text font-semibold my-8 text-left'>Build your Carrer here</h1></div>
