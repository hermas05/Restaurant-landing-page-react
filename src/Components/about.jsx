  ...
  return (
    ...
    <>
      ...
      <div className='w-full h-[90vh] bg-black flex flex-col items-center p-20'>
        ...
        <div className=' text-[#706f6f] text-xl font-normal text-center max-w-[100vh]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi</div>
      ...
      <div className='w-full h-[120vh] bg-[#dddcdc] text-black p-10 flex flex-col items-center'>
        ...
        <div className='grid grid-cols-4 '>
          <div className='  px-[5rem] py-[2rem] flex flex-col items-center text-center'>
            ...
            <p className='font text-[1.2rem] font-normal text-[#696767]'>“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam eu ante eu lectus ornare porta.“</p>
          ...
          <div className='  px-[5rem] py-[2rem] flex flex-col items-center text-center'>
            ...
            <p className='font text-[1.2rem] font-normal text-[#696767]'>“Nunc molestie eros nec eros auctor, a dapibus diam iaculis. Aliquam erat volutpat. “</p>
