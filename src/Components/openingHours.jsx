...
const OpeningHours = () => {
  return (
    <div className='w-full h-[110vh] flex justify-evenly contact text-white '>
        ...
        <p className=' font font-normal text-xl px-3 py-1 '>10:00am – 1:00pm</p>
        ...
        <p className=' font font-normal text-xl px-3 py-1 '>3:00pm – 10:30pm</p>
        <div className='bg-[#85833c] h-[3px] w-[40dvh] my-4'></div>
        <p className=' font font-normal text-xl px-3 py-1 '>SUN</p>
        <p className=' font font-normal text-xl px-3 py-1 '>We are closed</p>
