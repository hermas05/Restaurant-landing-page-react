        ...
        <div className='flex gap-20'>
          <div className=' w-[60%] '>
            <div className='grid grid-cols-2 gap-5'>
              <input type='text' placeholder='Name' className='"block py-3  px-4 w-full  text-black font text-lg bg-transparent border-2  border-[#696767] appearance-none dark:text-black dark:border-gray-900 dark:focus:border-[#85833c] focus:outline-none focus:ring-0 focus:border-[#85833c] peer placeholder:text-lg font text-black' />
              <input type='email' placeholder='Email Address' className='"block py-3  px-4 w-full  text-black font text-lg bg-transparent border-2  border-[#696767] appearance-none dark:text-black dark:border-gray-900 dark:focus:border-[#85833c] focus:outline-none focus:ring-0 focus:border-[#85833c] peer placeholder:text-lg font text-black' />
              ...
              <input type='text' placeholder='Subject' className='"block py-3  px-4 w-full  text-black font text-lg bg-transparent border-2  border-[#696767] appearance-none dark:text-black dark:border-gray-900 dark:focus:border-[#85833c] focus:outline-none focus:ring-0 focus:border-[#85833c] peer placeholder:text-lg font text-black' />
            </div>
            <div className='mt-5'>
          ...
          <div className='mt-[-100px] w-[25%] flex flex-col bg-white p-10 h-[90vh] shadow-md text-center'>
            ...
            <h3 className='text-[#696767] font font-bold text-lg px-3 py-1 mt-2'>CONTACT</h3>
            <h1 className='text-black text-lg middle-text font-semibold  px-3'>933, Park Street</h1>
            <h3 className='text-[#696767] font font-normal text-lg px-3  mt-2'>Chennai-60028</h3>
            <h3 className='text-[#696767] font font-normal text-lg px-3  mt-2'>Tel -778 234 9876</h3>
          </div>
        </div>
      </div>
      <OpeningHours />
